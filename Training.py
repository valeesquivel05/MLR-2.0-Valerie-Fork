...
test_loader_noSkip = torch.utils.data.DataLoader(dataset=ConcatDataset([emnist_test_dataset, mnist_dataset]), batch_size=bs, shuffle=True, drop_last=True)
emnist_skip = torch.utils.data.DataLoader(dataset=emnist_skip, batch_size=bs, shuffle=True,  drop_last= True)
mnist_skip = torch.utils.data.DataLoader(dataset=mnist_skip, batch_size=bs, shuffle=True,  drop_last= True)
